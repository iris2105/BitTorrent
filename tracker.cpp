...
int main(int argc, char* argv[]){
    if(argc!=2){
        cout << "Usage: ./tracker <tracker_info_file>" << endl;
        exit(1);
    }
    ...
    server_addr.sin_addr.s_addr = INADDR_ANY; // Use INADDR_ANY to bind to all interfaces
    // If you want to bind to a specific IP address, use inet_pton
    // Example: inet_pton(AF_INET, ip, &server_addr.sin_addr);
